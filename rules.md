...
- Địa hình mỗi ô không đổi suốt trận. Bản đồ trong setup chỉ gồm width/height/cells (không có sẵn danh sách ô kề) — bot tự tính hình học lục giác even-r (hàng chẵn lệch phải). Xem code mẫu ở trang Tài liệu API.
...
1. Nhiều loại udon khác nhau nhất trong trận.
2. Tổng lũy kế số loại udon thu mỗi ngày cao nhất.
3. Tổng số phần udon thu được nhiều nhất.
4. Tổng thời gian phản hồi (câu trả lời hợp lệ cuối mỗi ngày) thấp nhất.
5. Nếu vẫn hoà: tung xúc xắc hoặc tuyên bố hoà.
